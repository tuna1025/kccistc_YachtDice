...
----
# 이미지 한 장 테스트
python tests/predict.py --source "C:\\path\\to\\dice.jpg"

# 테스트 이미지 폴더 전체 테스트
python tests/predict.py --source "Dice.v2-medium-color.yolov11\\export\\images"
...
def main() -> None:
    ...
    if not weights.is_file():
        raise FileNotFoundError(
            ...
            "먼저 train.py로 학습을 완료했는지 확인하거나 --weights에 best.pt 경로를 지정하세요."
        )
